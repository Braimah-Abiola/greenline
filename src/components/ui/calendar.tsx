...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("px-4 pt-5 pb-4", className)}
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-lg w-12 font-normal text-base",
        row: "flex w-full mt-2",
        cell: cn(
          "relative p-0 text-center text-base focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-lg",
          props.mode === "range"
        ...
        day: cn(
          ...
          "size-12 text-lg p-0 font-normal aria-selected:opacity-100"
        ),
        day_range_start:
